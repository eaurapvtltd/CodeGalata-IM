...
export function seedInitialDataIfNeeded(): void {
  ...
  if (colleges.length === 0) {
    ...
    const demoStudents: Student[] = [
      { id: 'st-1', batchId: 'batch-cse-a', studentName: 'Aarav Sharma', cgpa: 8.9, email: 'aarav@cgit.edu', status: 'Activated', createdAt: new Date().toISOString(), rollNo: 'CSE2025001', phone: '9876543210', attendancePct: 88, solvedProblemsCount: 24, activityLogs: [{ action: 'Solved Two Sum', timestamp: new Date().toISOString() }] },
      { id: 'st-2', batchId: 'batch-cse-a', studentName: 'Diya Patel', cgpa: 9.4, email: 'diya@cgit.edu', status: 'Working', createdAt: new Date().toISOString(), rollNo: 'CSE2025002', phone: '9876543211', attendancePct: 94, solvedProblemsCount: 42, activityLogs: [{ action: 'Solved Longest Substring', timestamp: new Date().toISOString() }] },
      { id: 'st-3', batchId: 'batch-cse-a', studentName: 'Rohan Verma', cgpa: 7.8, email: 'rohan@cgit.edu', status: 'Not Activated', createdAt: new Date().toISOString(), rollNo: 'CSE2025003', phone: '9876543212', attendancePct: 75, solvedProblemsCount: 5, activityLogs: [] },
      { id: 'st-4', batchId: 'batch-cse-b', studentName: 'Ananya Reddy', cgpa: 8.7, email: 'ananya@cgit.edu', status: 'Not Activated', createdAt: new Date().toISOString(), rollNo: 'CSE2025004', phone: '9876543213', attendancePct: 82, solvedProblemsCount: 12, activityLogs: [] },
    ];
...
export function addSingleStudent(collegeId: string, params: {
  ...
  const newStudent: Student = {
    ...
    status: params.status || 'Not Activated',
    createdAt: new Date().toISOString(),
    attendancePct: 100,
