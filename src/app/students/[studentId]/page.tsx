              ...
              <div className="space-y-1">
                <div className="flex items-center gap-3 flex-wrap">
                  ...
                  <span className="px-3 py-1 rounded-full bg-zinc-100 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 font-mono text-xs font-semibold flex items-center gap-1.5">
                    ...
                    Registered On: {student.registeredOn || '17/07/2026, 11:22 pm'}
                  </span>
                  <span className="px-3 py-1 rounded-full bg-zinc-100 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 font-mono text-xs font-semibold flex items-center gap-1.5">
                    <Clock className="w-3.5 h-3.5 text-zinc-400" />
                    Last Login: {student.lastLogin || '17/07/2026, 11:22 pm'}
                  </span>
                </div>

                <div className="flex items-center gap-4 text-xs text-zinc-500 dark:text-zinc-400 flex-wrap pt-1">
